...
const getAllLandingNotes = (callId, params) => Gateway.get(`/material_management/get_all_landing_notes_summary/${callId}`, { params });
...
const getLandingNotesTotal = (callId) => Gateway.get(`/material_management/get_landing_notes_total/${callId}`);

export default { getAllLandingNotes, getLandingNoteById, saveLandingNote, updateLandingNote, deleteLandingNote, convertLandingNoteToDispatch, printLandingNote, getLandingNotesTotal };
