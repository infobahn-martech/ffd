...
const addDriverVehicleMappingData = (data) => Gateway.post('/transport/add_driver_vehicle', data);
const getDriverVehicleMappingData = ({ params }) => Gateway.get('/transport/get_all_driver_vehicles', { params });
const updateDriverVehicleMappingData = (data) => Gateway.post(`/transport/update_driver_vehicle`, data);
