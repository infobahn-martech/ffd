    ...
    <div className="kpi-satisfaction-card">
      ...
      <div className="kpi-satisfaction-card__gauge-wrapper">
        <div className="kpi-satisfaction-card__gauge">
          <svg className="kpi-satisfaction-card__gauge-svg" viewBox="0 0 200 200">
            <defs>
            ...
            <circle
              ...
              strokeLinecap="round"
            />
            {/* Progress circle - starts from bottom-left, moves clockwise */}
            <circle
              cx={centerX}
              cy={centerY}
              r={radius}
            ...
            <circle cx={centerX} cy={centerY} r="18" fill="#0075FF" />
            <foreignObject x={centerX - 12.5} y={centerY - 12.5} width="25" height="25">
        ...
        <div className="kpi-satisfaction-card__info-box">
