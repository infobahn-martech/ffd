...
export function OperatorModal({ showModal, closeModal }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const onSubmit = (data) => {
        console.log("OPERATOR FORM SUBMITTED:", data);
        closeModal();
    };
    ...
    const renderHeader = () => (
        <>
            <h1 className="modal-title">
                {showModal?._id ? "Edit Operator" : "Add Operator"}
            </h1>
        </>
    );
    ...
    const renderFooter = () => (
        <div className="modal-footer">
            ...
            <button type="submit" form="operatorForm" className="btn btn-primary">
                Save
            </button>
        </div>
    );
