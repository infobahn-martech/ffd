...
const DriverVehicleMapping = () => {
    ...
    const [showDriverVehicleMappingModal, setShowDriverVehicleMappingModal] = useState(false);
    ...
    const cols = [
        {
            name: "DriverVehicleMapping Name",
                ...
                <div className="prospect employee">
                    <div className="container-fluid">
                        <CommonHeader
                            ...
                            isAddEnabled
                            addModalLabel="Add DriverVehicleMapping"
                            setSearch={(e) =>
