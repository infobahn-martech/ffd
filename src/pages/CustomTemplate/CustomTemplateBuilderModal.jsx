...
function CustomTemplateBuilderModal({ show, onClose, initialTemplate = null }) {
    const getBillingEntities = useBillingEntityReducer((s) => s.getBillingEntities);
    const billingEntities = useBillingEntityReducer((s) => s.billingEntities);
    const billingLoading = useBillingEntityReducer((s) => s.isLoading);
    const success = useAlertReducer((s) => s.success);
