  ...
  const renderTypeSelection = () => (
    <div className="new-workspace-modal-content">
      <div className="new-workspace-modal-header">
        <h2 className="new-workspace-modal-title">New Workspace</h2>
        <button
          type="button"
      ...
      <div className="workspace-type-selection">
        {/* Team Workspace Card */}
        <div
          className="workspace-type-card"
          onClick={() => handleTypeSelect('team')}
        >
          <div className="workspace-type-card-content">
            <div className="workspace-type-card-text">
              <h3 className="workspace-type-title">Team Workspace</h3>
            ...
            <div className="workspace-type-illustration">
        ...
        <div
          className="workspace-type-card"
          onClick={() => handleTypeSelect('management')}
        >
          <div className="workspace-type-card-content">
            <div className="workspace-type-card-text">
              <h3 className="workspace-type-title">Management Workspace</h3>
              <p className="workspace-type-description">
