...
import { TaskDocumentFilePreview, TaskDocumentHeader, TaskDocumentList } from "../../shared/TaskDocuments";
...
function GROSupervisorDocuments({
  documents,
  hideHeading = false,
  ...
  return (
    <div
      ...
      aria-label={heading}
    >
      {!hideHeading ? <TaskDocumentHeader title={heading} /> : null}
      <TaskDocumentList
        isLoading={isLoading}
        isEmpty={showEmptyState}
        emptyMessage={emptyMessage || "No documents found for this task."}
        listClassName="gro-supervisor-document-list"
      >
        {documents.map((doc) => {
...
GROSupervisorDocuments.propTypes = {
...
export default GROSupervisorDocuments;
