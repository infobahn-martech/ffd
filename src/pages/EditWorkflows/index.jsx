...
function EditWorkflows() {
            ...
            swimlanes: [
                {
                    ...
                    name: 'Portfolio Lane',
                    stages: [
                        { id: 1, name: 'Backlog', area: 'BACKLOG AREA', limit: 0, cardsPerRow: 1 },
                        { id: 2, name: 'Requested', area: 'REQUESTED AREA', limit: 0, cardsPerRow: 1 },
                        { id: 3, name: 'In Progress', area: 'IN PROGRESS AREA', limit: 0, cardsPerRow: 1 },
                        { id: 4, name: 'Done', area: 'DONE AREA', limit: 0, cardsPerRow: 1 },
                        { id: 5, name: 'Ready to Archive', area: 'READY TO ARCHIVE AREA', limit: 0, cardsPerRow: 1 },
                    ],
                },
            ],
        },
    ...
    // Handle adding a new column (duplicate) at the bottom (end of row)
