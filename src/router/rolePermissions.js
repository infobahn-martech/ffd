...
export const routePermissions = {
  [ROUTE_PATHS.DASHBOARD]: [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR, ROLE_IDS.FINANCE],
  ...
  "/permissions": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN],
  ...
  "/customer-pricing-infobhan": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.FINANCE],
  ...
  "/time-objects": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.VENDOR],
  "/stage-time-mappings": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.VENDOR],
  ...
  "/order-history": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.VENDOR],
  "/document-checklist": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  ...
  [ROUTE_PATHS.OPERATORS]: [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  [ROUTE_PATHS.MWP_HISTORY]: [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/lh-services": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/transport-company": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/hospital-management": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/medical-services": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/hospital-services": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/third-party-service": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/crew-template": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/kpi-dashboard": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR, ROLE_IDS.FINANCE],
  "/kpi-tasks": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR, ROLE_IDS.FINANCE],
  "/kpi-users": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR, ROLE_IDS.FINANCE],
  "/da-module": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR],
  "/vendor-portal/dashboard": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR, ROLE_IDS.FINANCE],
  "/vendor-portal/invoices": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR, ROLE_IDS.FINANCE],
  "/vendor-portal/orders": [ROLE_IDS.SUPER_ADMIN, ROLE_IDS.ADMIN, ROLE_IDS.PORT_ADMIN, ROLE_IDS.PORT_OPERATOR, ROLE_IDS.PORT_MANAGER, ROLE_IDS.VENDOR, ROLE_IDS.FINANCE],
