import { isGROSupervisorRole } from "./groUserRoles";
...
/**
 * Resolves CardForm variant for the logged-in user and card workflow.
 * GRO Supervisor (role_id 6) always opens a blank card shell; GRO User (4) uses workflow role.
 * @param {unknown} workflowRoleId
 * @param {unknown} userRoleId
 * @returns {"gro"|"custom"|"default"|"empty"}
 */
export function resolveCardFormVariant(workflowRoleId, userRoleId) {
